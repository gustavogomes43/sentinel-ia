...
| **Amazon Bedrock** | Inferência Multimodal | **SaaS (AI Service)** | **Claude 4.5 Haiku** | ~$0.00025 por análise de imagem |
...
Nota: O Sentinel IA utiliza o Claude 4.5, aproveitando as capacidades mais recentes de raciocínio multimodal e precisão analítica para minimizar falsos positivos em ambientes críticos.
